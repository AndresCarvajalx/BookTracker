                ...
                <div className="px-4 md:px-0 lg:w-6/12">
                  <div className="md:mx-6 md:p-12">
                    ...
                    <form onSubmit={handleSubmit}>
                      <p className="mb-4">
                        Crea una cuenta para empezar a usar BookTracker
                      </p>
                ...
                <div className="flex items-center rounded-b-lg lg:w-6/12 lg:rounded-r-lg lg:rounded-bl-none bg-(--color-bg) ">
                  <div className="px-4 py-6 text-white md:mx-6 md:p-12">
                    ...
                    <p className="text-sm text-amber-950 text-justify">
                      ...
                      posees, los que has leído y los que planeas leer. Además,
                      te permite explorar detalles sobre tus libros favoritos y
                      mantener un historial de tus lecturas. ¡Descubre una forma
                      más sencilla y eficiente de disfrutar de tu pasión por la
                      lectura!
                    </p>
                  </div>
                </div>
